function DE_parseLineDefType() {
	...
	var Push = "P", Repeat = "R", Switched = "S", Walkover = "W", Gun = "G", Once = "1";
	...
	if WAD_FORMAT == "DOOM"{//Disable hexen format for now, that requires implementing different functions
		...
		switch specialtype{
			...
			case	1	: CLASS = Reg;	TRIG = [Push,Repeat];	LOCK = No;	SPEED = Slow;	WAIT =	4;	MONST =	Yes	; FUNC = [Open, Wait, Close];break;
			case	117	: CLASS = Reg;	TRIG = [Push,Repeat];	LOCK = No;	SPEED = Fast;	WAIT =	4;	MONST =	No	; FUNC = [Open, Wait, Close];break;
			case	63	: CLASS = Reg;	TRIG = [Switched,Repeat];	LOCK = No;	SPEED = Slow;	WAIT =	4;	MONST =	No	; FUNC = [Open, Wait, Close];break;
			case	114	: CLASS = Reg;	TRIG = [Switched,Repeat];	LOCK = No;	SPEED = Fast;	WAIT =	4;	MONST =	No	; FUNC = [Open, Wait, Close];break;
			...
			case	90	: CLASS = Reg;	TRIG = [Walkover,Repeat];	LOCK = No;	SPEED = Slow;	WAIT =	4;	MONST =	No	; FUNC = [Open, Wait, Close];break;
			case	105	: CLASS = Reg;	TRIG = [Walkover,Repeat];	LOCK = No;	SPEED = Fast;	WAIT =	4;	MONST =	No	; FUNC = [Open, Wait, Close];break;
			...
			case	61	: CLASS = Reg;	TRIG = [Switched,Repeat];	LOCK = No;	SPEED = Slow;	WAIT =	-1;	MONST =	No	; FUNC = [Open];break;
			case	115	: CLASS = Reg;	TRIG = [Switched,Repeat];	LOCK = No;	SPEED = Fast;	WAIT =	-1;	MONST =	No	; FUNC = [Open];break;
			...
			case	86	: CLASS = Reg;	TRIG = [Walkover,Repeat];	LOCK = No;	SPEED = Slow;	WAIT =	-1;	MONST =	No	; FUNC = [Open];break;
			case	106	: CLASS = Reg;	TRIG = [Walkover,Repeat];	LOCK = No;	SPEED = Fast;	WAIT =	-1;	MONST =	No	; FUNC = [Open];break;
			...
			case	46	: CLASS = Reg;	TRIG = [Gun,Repeat];	LOCK = No;	SPEED = Slow;	WAIT =	-1;	MONST =	No	; FUNC = [Open];break;
			case	42	: CLASS = Reg;	TRIG = [Switched,Repeat];	LOCK = No;	SPEED = Slow;	WAIT =	-1;	MONST =	No	; FUNC = [Close];break;
			case	116	: CLASS = Reg;	TRIG = [Switched,Repeat];	LOCK = No;	SPEED = Fast;	WAIT =	-1;	MONST =	No	; FUNC = [Close];break;
			...
			case	75	: CLASS = Reg;	TRIG = [Walkover,Repeat];	LOCK = No;	SPEED = Slow;	WAIT =	-1;	MONST =	No	; FUNC = [Close];break;
			case	107	: CLASS = Reg;	TRIG = [Walkover,Repeat];	LOCK = No;	SPEED = Fast;	WAIT =	-1;	MONST =	No	; FUNC = [Close];break;
			...
			case	196	: CLASS = Ext;	TRIG = [Switched,Repeat];	LOCK = No;	SPEED = Slow;	WAIT =	30;	MONST =	No	; FUNC = [Close, Wait, Open];break;
			case	175	: CLASS = Ext;	TRIG = [Switched,Once];	LOCK = No;	SPEED = Slow;	WAIT =	30;	MONST =	No	; FUNC = [Close, Wait, Open];break;
			case	76	: CLASS = Reg;	TRIG = [Walkover,Repeat];	LOCK = No;	SPEED = Slow;	WAIT =	30;	MONST =	No	; FUNC = [Close, Wait, Open];break;
			...
			case	26	: CLASS = Reg;	TRIG = [Push,Repeat];	LOCK = Blue;	SPEED = Slow;	WAIT = 4 ;	MONST = No; FUNC = [Open, Wait, Close];break;
			case	28	: CLASS = Reg;	TRIG = [Push,Repeat];	LOCK = Red;		SPEED = Slow;	WAIT = 4 ;	MONST = No; FUNC = [Open, Wait, Close];break;
			case	27	: CLASS = Reg;	TRIG = [Push,Repeat];	LOCK = Yell;	SPEED = Slow;	WAIT = 4 ;	MONST = No; FUNC = [Open, Wait, Close];break;
			...
			case	99	: CLASS = Reg;	TRIG = [Switched,Repeat];	LOCK = Blue;	SPEED = Fast;	WAIT = -1;	MONST = No; FUNC = [Open];break;
			case	134	: CLASS = Reg;	TRIG = [Switched,Repeat];	LOCK = Red;		SPEED = Fast;	WAIT = -1;	MONST = No; FUNC = [Open];break;
			case	136	: CLASS = Reg;	TRIG = [Switched,Repeat];	LOCK = Yell;	SPEED = Fast;	WAIT = -1;	MONST = No; FUNC = [Open];break;
			...
			case	60	: CLASS = Reg; TRIG =[Switched,Repeat];	DIR = "Dn"; SPEED = Slow; TEXTURE_CHANGE = "None"; MODEL = "--" ; MONST= No; CRUSH = No;	TARGET = "Lowest Neighbor Floor";break;
			...
			case	82	: CLASS = Reg; TRIG =[Walkover,Repeat];	DIR = "Dn"; SPEED = Slow; TEXTURE_CHANGE = "None"; MODEL = "--" ; MONST= No; CRUSH = No;	TARGET = "Lowest Neighbor Floor";break;
			...
			case	177	: CLASS = Ext; TRIG =[Switched,Repeat];	DIR = "Dn"; SPEED = Slow; TEXTURE_CHANGE = "TxTy"; MODEL = "Num"; MONST= No; CRUSH = No;	TARGET = "Lowest Neighbor Floor";break;
			...
			case	84	: CLASS = Reg; TRIG =[Walkover,Repeat];	DIR = "Dn"; SPEED = Slow; TEXTURE_CHANGE = "TxTy"; MODEL = "Num"; MONST= No; CRUSH = No;	TARGET = "Lowest Neighbor Floor";break;
			...
			case	69	: CLASS = Reg; TRIG =[Switched,Repeat];	DIR = "Up"; SPEED = Slow; TEXTURE_CHANGE = "None"; MODEL = "--" ; MONST= No; CRUSH = No;	TARGET = "Next Neighbor Floor";break;
			...
			case	128	: CLASS = Reg; TRIG =[Walkover,Repeat];	DIR = "Up"; SPEED = Slow; TEXTURE_CHANGE = "None"; MODEL = "--" ; MONST= No; CRUSH = No;	TARGET = "Next Neighbor Floor";break;
			...
			case	132	: CLASS = Reg; TRIG =[Switched,Repeat];	DIR = "Up"; SPEED = Fast; TEXTURE_CHANGE = "None"; MODEL = "--" ; MONST= No; CRUSH = No;	TARGET = "Next Neighbor Floor";break;
			...
			case	129	: CLASS = Reg; TRIG =[Walkover,Repeat];	DIR = "Up"; SPEED = Fast; TEXTURE_CHANGE = "None"; MODEL = "--" ; MONST= No; CRUSH = No;	TARGET = "Next Neighbor Floor";break;
			...
			case	222	: CLASS = Ext; TRIG =[Switched,Repeat];	DIR = "Dn"; SPEED = Slow; TEXTURE_CHANGE = "None"; MODEL = "--" ; MONST= No; CRUSH = No;	TARGET = "Next Neighbor Floor";break;
			...
			case	220	: CLASS = Ext; TRIG =[Walkover,Repeat];	DIR = "Dn"; SPEED = Slow; TEXTURE_CHANGE = "None"; MODEL = "--" ; MONST= No; CRUSH = No;	TARGET = "Next Neighbor Floor";break;
			...
			case	64	: CLASS = Reg; TRIG =[Switched,Repeat];	DIR = "Up"; SPEED = Slow; TEXTURE_CHANGE = "None"; MODEL = "--" ; MONST= No; CRUSH = No;	TARGET = "Lowest Neighbor Ceiling";break;
			...
			case	91	: CLASS = Reg; TRIG =[Walkover,Repeat];	DIR = "Up"; SPEED = Slow; TEXTURE_CHANGE = "None"; MODEL = "--" ; MONST= No; CRUSH = No;	TARGET = "Lowest Neighbor Ceiling";break;
			...
			case	65	: CLASS = Reg; TRIG =[Switched,Repeat];	DIR = "Up"; SPEED = Slow; TEXTURE_CHANGE = "None"; MODEL = "--" ; MONST= No; CRUSH = Yes;	TARGET = "Lowest Neighbor Ceiling - 8";break;
			...
			case	94	: CLASS = Reg; TRIG =[Walkover,Repeat];	DIR = "Up"; SPEED = Slow; TEXTURE_CHANGE = "None"; MODEL = "--" ; MONST= No; CRUSH = Yes;	TARGET = "Lowest Neighbor Ceiling - 8";break;
			...
			case	45	: CLASS = Reg; TRIG =[Switched,Repeat];	DIR = "Dn"; SPEED = Slow; TEXTURE_CHANGE = "None"; MODEL = "--" ; MONST= No; CRUSH = No;	TARGET = "Highest Neighbor Floor";break;
			...
			case	83	: CLASS = Reg; TRIG =[Walkover,Repeat];	DIR = "Dn"; SPEED = Slow; TEXTURE_CHANGE = "None"; MODEL = "--" ; MONST= No; CRUSH = No;	TARGET = "Highest Neighbor Floor";break;
			...
			case	70	: CLASS = Reg; TRIG =[Switched,Repeat];	DIR = "Dn"; SPEED = Fast; TEXTURE_CHANGE = "None"; MODEL = "--" ; MONST= No; CRUSH = No;	TARGET = "Highest Neighbor Floor + 8";break;
			...
			case	98	: CLASS = Reg; TRIG =[Walkover,Repeat];	DIR = "Dn"; SPEED = Fast; TEXTURE_CHANGE = "None"; MODEL = "--" ; MONST= No; CRUSH = No;	TARGET = "Highest Neighbor Floor + 8";break;
			...
			case	180	: CLASS = Ext; TRIG =[Switched,Repeat];	DIR = "Up"; SPEED = Slow; TEXTURE_CHANGE = "None"; MODEL = "--" ; MONST= No; CRUSH = No;	TARGET = "Absolute 24";break;
			...
			case	92	: CLASS = Reg; TRIG =[Walkover,Repeat];	DIR = "Up"; SPEED = Slow; TEXTURE_CHANGE = "None"; MODEL = "--" ; MONST= No; CRUSH = No;	TARGET = "Absolute 24";break;
			...
			case	179	: CLASS = Ext; TRIG =[Switched,Repeat];	DIR = "Up"; SPEED = Slow; TEXTURE_CHANGE = "TxTy"; MODEL = "Trg"; MONST= No; CRUSH = No;	TARGET = "Absolute 24";break;
			...
			case	93	: CLASS = Reg; TRIG =[Walkover,Repeat];	DIR = "Up"; SPEED = Slow; TEXTURE_CHANGE = "TxTy"; MODEL = "Trg"; MONST= No; CRUSH = No;	TARGET = "Absolute 24";break;
			...
			case	176	: CLASS = Ext; TRIG =[Switched,Repeat];	DIR = "Up"; SPEED = Slow; TEXTURE_CHANGE = "None"; MODEL = "--" ; MONST= No; CRUSH = No;	TARGET = "Abs Shortest Lower Texture";break;
			...
			case	96	: CLASS = Reg; TRIG =[Walkover,Repeat];	DIR = "Up"; SPEED = Slow; TEXTURE_CHANGE = "None"; MODEL = "--" ; MONST= No; CRUSH = No;	TARGET = "Abs Shortest Lower Texture";break;
			...
			case	178	: CLASS = Ext; TRIG =[Switched,Repeat];	DIR = "Up"; SPEED = Slow; TEXTURE_CHANGE = "None"; MODEL = "--" ; MONST= No; CRUSH = No;	TARGET = "Absolute 512";break;
			...
			case	147	: CLASS = Ext; TRIG =[Walkover,Repeat];	DIR = "Up"; SPEED = Slow; TEXTURE_CHANGE = "None"; MODEL = "--" ; MONST= No; CRUSH = No;	TARGET = "Absolute 512";break;
			...
			case	190	: CLASS = Ext; TRIG =[Switched,Repeat];	DIR = "--"; SPEED = "--"; TEXTURE_CHANGE = "TxTy"; MODEL = "Trg"; MONST= No; CRUSH = No;	TARGET = "None";break;
			case	189	: CLASS = Ext; TRIG =[Switched,Once];	DIR = "--"; SPEED = "--"; TEXTURE_CHANGE = "TxTy"; MODEL = "Trg"; MONST= No; CRUSH = No;	TARGET = "None";break;
			case	154	: CLASS = Ext; TRIG =[Walkover,Repeat];	DIR = "--"; SPEED = "--"; TEXTURE_CHANGE = "TxTy"; MODEL = "Trg"; MONST= No; CRUSH = No;	TARGET = "None";break;
			case	153	: CLASS = Ext; TRIG =[Walkover,Once];	DIR = "--"; SPEED = "--"; TEXTURE_CHANGE = "TxTy"; MODEL = "Trg"; MONST= No; CRUSH = No;	TARGET = "None";break;
			case	78	: CLASS = Ext; TRIG =[Switched,Repeat];	DIR = "--"; SPEED = "--"; TEXTURE_CHANGE = "TxTy"; MODEL = "Num"; MONST= No; CRUSH = No;	TARGET = "None";break;
			case	241	: CLASS = Ext; TRIG =[Switched,Once];	DIR = "--"; SPEED = "--"; TEXTURE_CHANGE = "TxTy"; MODEL = "Num"; MONST= No; CRUSH = No;	TARGET = "None";break;
			case	240	: CLASS = Ext; TRIG =[Walkover,Repeat];	DIR = "--"; SPEED = "--"; TEXTURE_CHANGE = "TxTy"; MODEL = "Num"; MONST= No; CRUSH = No;	TARGET = "None";break;
