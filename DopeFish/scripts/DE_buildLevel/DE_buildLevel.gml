...
//	if(node_c_r&SUbacksectorOR)
//		DE_buildSSectorOld(data,map,node,0,node_c_r&~SUbacksectorOR);
//	if(node_c_l&SUbacksectorOR)
//		DE_buildSSectorOld(data,map,node,1,node_c_l&~SUbacksectorOR);
...
//	//this.wad.bsplinesdata= Float32Array(bsplines);
//	//this.wad.bsplinesindices= Float32Array(bspidx);
