//wadLoader_addWall=function(data,map,front,back,start,end_,flags){
/*
...
var width=wadLoader_wallLength(sv,ev);
var height=0;
var peg='';
...
wadLoader_buildFace(data,front,
...
var ftex = ds_map_find_value_fixed(wadWallTextures,ds_map_find_value_fixed(front,"tex_l"));
...
var utex = ds_map_find_value_fixed(wadWallTextures,ds_map_find_value_fixed(front,"tex_u"));
