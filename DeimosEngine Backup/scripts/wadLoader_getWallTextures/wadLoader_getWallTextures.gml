...
for(l=0;l<ds_list_size(wadDirectory);l+=1){
    ...
    switch(n){
        ...
        for(var t=0;t<tcount;t+=1){
            ...
            //show_debug_message("NOTICE: Found "+tname+" in Lump["+n+"]");
            ...
            //show_debug_message("NOTICE: Found "+string(ds_map_find_value_fixed(texture,"patchc"))+" wadPatches in Texture["+tname+"]");
            ...
            ds_map_add(wadWallTextures,tname,texture);
        }
    break;
