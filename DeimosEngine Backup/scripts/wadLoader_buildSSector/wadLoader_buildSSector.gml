/// @description wadLoader_buildSSector=function(data,map,node,side,ss){
/// @param data
/// @param map
/// @param node
/// @param side
...
if(line_left){
wadLoader_addWall(data,map,ds_map_find_value_fixed(sidedefs,line_right),
...
if(line_right){
wadLoader_addWall(data,map,ds_map_find_value_fixed(sidedefs,line_left),
...
// Get Thing Heights
//wadLoader_findThingInSSector(map,(!side)?node.bb_r:node.bb_l,data.floor);
