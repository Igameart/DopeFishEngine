switch type{
	case 		 1:
	NAME =		"Polyobj_StartLine";
	CATEGORY =	"PolyObjects";
	SCRIPT =	"No script";
	LINE =		"";break;
	...
	case 		 159:
	NAME =		"Sector_SetPlaneReflection";
	CATEGORY =	"Renderer";
	SCRIPT =	"";
	LINE =		"";break;
	...
	case 		 256:
	NAME =		"Floor_LowerToHighestEE";
	CATEGORY =	"Floors";
	SCRIPT =	"";
	LINE =		"";break;

	case 		 257:
	NAME =		"Floor_RaiseToLowest";
	CATEGORY =	"Floors";
	SCRIPT =	"";
	LINE =		"";break;

	case 		 258:
	NAME =		"Floor_LowerToLowestCeiling";
	CATEGORY =	"Floors";
	SCRIPT =	"";
	LINE =		"";break;

	case 		 259:
	NAME =		"Floor_RaiseToCeiling";
	CATEGORY =	"Floors";
	SCRIPT =	"";
	LINE =		"";break;

	case 		 260:
	NAME =		"Floor_ToCeilingInstant";
	CATEGORY =	"Floors";
	SCRIPT =	"";
	LINE =		"";break;

	case 		 261:
	NAME =		"Floor_LowerByTexture";
	CATEGORY =	"Floors";
	SCRIPT =	"";
	LINE =		"";break;

	case 		 262:
	NAME =		"Ceiling_RaiseToHighest";
	CATEGORY =	"Ceilings";
	SCRIPT =	"";
	LINE =		"";break;
																		
	case 		 263:
	NAME =		"Ceiling_ToHighestInstant";
	CATEGORY =	"Ceilings";
	SCRIPT =	"";
	LINE =		"";break;

	case 		 264:
	NAME =		"Ceiling_LowerToNearest";
	CATEGORY =	"Ceilings";
	SCRIPT =	"";
	LINE =		"";break;

	case 		 265:
	NAME =		"Ceiling_RaiseToLowest";
	CATEGORY =	"Ceilings";
	SCRIPT =	"";
	LINE =		"";break;

	case 		 266:
	NAME =		"Ceiling_RaiseToHighestFloor";
	CATEGORY =	"Ceilings";
	SCRIPT =	"";
	LINE =		"";break;

	case 		 267:
	NAME =		"Ceiling_ToFloorInstant";
	CATEGORY =	"Ceilings";
	SCRIPT =	"";
	LINE =		"";break;

	case 		 268:
	NAME =		"Ceiling_RaiseByTexture";
	CATEGORY =	"Ceilings";
	SCRIPT =	"";
	LINE =		"";break;

	case 		 269:
	NAME =		"Ceiling_LowerByTexture";
	CATEGORY =	"Ceilings";
	SCRIPT =	"";
	LINE =		"";break;

	case 		 270:
	NAME =		"Stairs_BuildDownDoom";
	CATEGORY =	"Stairs";
	SCRIPT =	"";
	LINE =		"";break;

	case 		 271:
	NAME =		"Stairs_BuildUpDoomSync";
	CATEGORY =	"Stairs";
	SCRIPT =	"";
	LINE =		"";break;

	case 		 272:
	NAME =		"Stairs_BuildDownDoomSync";
	CATEGORY =	"Stairs";
	SCRIPT =	"";
	LINE =		"";break;

	case 		 273:
	NAME =		"Stairs_BuildUpDoomCrush";
	CATEGORY =	"Stairs";
	SCRIPT =	"";
	LINE =		"";break;

	case 		 274:
	NAME =		"Door_AnimatedClose";
	CATEGORY =	"Doors";
	SCRIPT =	"";
	LINE =		"";break;
	...
	case 		 277:
	NAME =		"Sector_SetFloorGlow";
	CATEGORY =	"Sectors";
	SCRIPT =	"";
	LINE =		"";break;

	case 		 278:
	NAME =		"Sector_SetCeilingGlow";
	CATEGORY =	"Sectors";
	SCRIPT =	"";
	LINE =		"";break;

	case 		 279:
	NAME =		"Floor_MoveToValueAndCrush";
	CATEGORY =	"Floors";
	SCRIPT =	"";
	LINE =		"";break;

	case 		 280:
	NAME =		"Ceiling_MoveToValueAndCrush";
	CATEGORY =	"Ceilings";
	SCRIPT =	"";
	LINE =		"";break;
}