...
wadLoader_buildSSector(data,map,node,0,node_c_r&~SUBSECTOR);
if(node_c_l&SUBSECTOR)
wadLoader_buildSSector(data,map,node,1,node_c_l&~SUBSECTOR);
...
//wadLoader_buildWallTextures(data);
//wadLoader_buildFlatTextures(data);
//wadLoader_buildSkyTextures(data);
